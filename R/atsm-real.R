...
atsm_real <- function(panel,
  ...
  structure(
    list(
      ...
      issuer = panel$meta$issuer[panel$meta$curve == nominal],
      instrument = c(nominal = panel$meta$instrument[panel$meta$curve == nominal],
                     real = panel$meta$instrument[panel$meta$curve == real]),
      dates = dates,
